    ...
    public class DeleteOperationClaimCommand : IRequest<DeletedOperationClaimDto>
    {
        ...
        public class DeleteOperationClaimCommandHandler : IRequestHandler<DeleteOperationClaimCommand, DeletedOperationClaimDto>
        {
            ...
            public async Task<DeletedOperationClaimDto> Handle(DeleteOperationClaimCommand request, CancellationToken cancellationToken)
            {
                ...
                var operationClaimBeDeleted = await _operationClaimRepository.GetAsync(o => o.Id == request.Id);
                _operationClaimBusinessRules.OperationClaimShouldExistWhenRequested(operationClaimBeDeleted);
                var deletedOperationClaim = await _operationClaimRepository.DeleteAsync(operationClaimBeDeleted);
